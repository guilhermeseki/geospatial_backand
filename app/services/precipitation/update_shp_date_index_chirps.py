...
# === CONFIG ===
mosaic_dir = Path("/mnt/workwork/geoserver_data/chirps")
shapefile_name = "chirps.shp"
old_shp = mosaic_dir / shapefile_name
fixed_shp = mosaic_dir / "chirps_fixed.shp"
...
target_layer = target_ds.CreateLayer("chirps_fixed", geom_type=ogr.wkbPolygon)
...
if prj_file.exists():
    shutil.copy(prj_file, mosaic_dir / "chirps_fixed.prj")
...
for ext in [".shp", ".shx", ".dbf", ".prj", ".cpg"]:
    ...
    if fixed_file.exists():
        fixed_file.rename(mosaic_dir / f"chirps{ext}")
