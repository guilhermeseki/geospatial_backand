#!/usr/bin/env python3
"""
Test downloading daily wind gust from ERA5 daily statistics.
Dataset: sis-agrometeorological-indicators
This is the CORRECT dataset for insurance wind gust data.
"""
import sys
...
print("="*80)
print("TESTING ERA5 DAILY WIND GUST DOWNLOAD")
print("="*80)
print(f"Date: {test_date}")
print(f"Source: sis-agrometeorological-indicators")
print(f"Dataset: ERA5 post-processed daily statistics (1940-present)")
print(f"Variable: 10m_wind_gust")
print(f"Statistic: Daily maximum")
print(f"Output: Daily max wind gust in km/h (for insurance)")
print("="*80)
print()

# Run the flow
result = wind_gust_daily_era5_flow(
